...
namespace gr {
  namespace sandbox {
    		...
    		msg_hdr_tail::sptr msg_hdr_tail::make()
    		{return gnuradio::get_initial_sptr(new msg_hdr_tail_impl());}

		// constructor
    		msg_hdr_tail_impl::msg_hdr_tail_impl() : block("msg_hdr_tail",
                 	...
                 	io_signature::make(0, 0, 0))
    		{
        		...
        		set_msg_handler(d_in_port, boost::bind(&msg_hdr_tail_impl::print_pdu, this ,_1));
    		}

		// destructor
    		msg_hdr_tail_impl::~msg_hdr_tail_impl() {}

    		void msg_hdr_tail_impl::print_pdu(pmt::pmt_t pdu)
    		{
