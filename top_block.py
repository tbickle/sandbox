...
# Title: Top Block
# Generated: Sat Oct 18 12:34:26 2014
##################################################
...
class top_block(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.sandbox_msg_sink_0 = sandbox.msg_sink()
        self.sandbox_msg_div_0 = sandbox.msg_div()
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_char*1, "/home/matt/sandbox/trig.dat", False)

        ##################################################
        # Connections
        ##################################################
        self.connect((self.blocks_pdu_to_tagged_stream_1, 0), (self.blocks_message_sink_0, 0))
        self.connect((self.blocks_pdu_to_tagged_stream_1, 0), (self.blocks_throttle_1, 0))
        self.connect((self.blocks_throttle_1, 0), (self.blocks_tag_debug_0, 0))
        self.connect((self.blocks_throttle_1, 0), (self.blocks_tagged_stream_to_pdu_1, 0))
        ...
        self.msg_connect(self.sandbox_msg_div_0, "out", self.blocks_pdu_to_tagged_stream_1, "pdus")
        self.msg_connect(self.sandbox_msg_div_0, "out", self.sandbox_msg_sink_0, "print_pdu")
